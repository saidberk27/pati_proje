...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1341, 778)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(-20, 0, 1361, 751))
        ...
        self.Takim_logo = QtWidgets.QGraphicsView(self.verticalLayoutWidget_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Takim_logo.sizePolicy().hasHeightForWidth())
        self.Takim_logo.setSizePolicy(sizePolicy)
        self.Takim_logo.setMinimumSize(QtCore.QSize(500, 175))
        self.Takim_logo.setMaximumSize(QtCore.QSize(500, 175))
        self.Takim_logo.setAlignment(QtCore.Qt.AlignCenter)
        self.Takim_logo.setObjectName("Takim_logo")
        self.logo_layout.addWidget(self.Takim_logo)
        ...
        self.Tarayici.setGeometry(QtCore.QRect(0, 0, 1341, 295))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Tarayici.sizePolicy().hasHeightForWidth())
        self.Tarayici.setSizePolicy(sizePolicy)
        self.Tarayici.setMinimumSize(QtCore.QSize(700, 295))
        self.Tarayici.setMaximumSize(QtCore.QSize(1500, 295))
        ...
        self.menuHata_Rapor = QtWidgets.QMenu(self.menuBar)
        self.menuHata_Rapor.setObjectName("menuHata_Rapor")
        self.menuEme_i_Ge_enler = QtWidgets.QMenu(self.menuBar)
        self.menuEme_i_Ge_enler.setObjectName("menuEme_i_Ge_enler")
        self.menuProje_Detaylar = QtWidgets.QMenu(self.menuBar)
        self.menuProje_Detaylar.setObjectName("menuProje_Detaylar")
        ...
        self.menuHata_Rapor.addAction(self.action3B_Tasar_m)
        self.menuHata_Rapor.addAction(self.actionProje_Raporu)
        self.menuHata_Rapor.addSeparator()
        self.menuHata_Rapor.addAction(self.actionKullan_lan_Sensorler)
        self.menuHata_Rapor.addAction(self.actionKullan_lan_Kartlar)
        self.menuHata_Rapor.addAction(self.actionKullan_lan_Programlama_Dilleri_ve_Algoritmalar)
        self.menuEme_i_Ge_enler.addAction(self.actionProje_Ekibi)
        self.menuEme_i_Ge_enler.addAction(self.actionTe_ekk_rler)
        self.menuProje_Detaylar.addAction(self.actionAr_za_Raporu_G_nder)
        self.menuProje_Detaylar.addAction(self.action_leti_im_Bilgilerini_D_zenle)
        self.menuProje_Detaylar.addAction(self.actionKaynak_Kodlar_n_G_r)
        self.menuProje_Detaylar.addSeparator()
        self.menuProje_Detaylar.addAction(self.actionTelif_Hakk)
        self.menuProje_Detaylar.addAction(self.actionS_zle_me)
        self.menuBar.addAction(self.menuAna_Sayfa.menuAction())
        self.menuBar.addAction(self.menuHata_Rapor.menuAction())
        self.menuBar.addAction(self.menuEme_i_Ge_enler.menuAction())
        self.menuBar.addAction(self.menuProje_Detaylar.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuHata_Rapor.setTitle(_translate("MainWindow", "Proje Detayları"))
        self.menuEme_i_Ge_enler.setTitle(_translate("MainWindow", "Emeği Geçenler"))
        self.menuProje_Detaylar.setTitle(_translate("MainWindow", "Seçenekler"))
